...
.factory('fireBaseData', function($firebase) {
	var ref = new Firebase("https://finalsrecipe.firebaseio.com/"),
    refCart = new Firebase("https://finalsrecipe.firebaseio.com/cart"),
    refUser = new Firebase("https://finalsrecipe.firebaseio.com/users"),
    refCategory = new Firebase("https://finalsrecipe.firebaseio.com/category"),
    refOrder = new Firebase("https://finalsrecipe.firebaseio.com/orders"),
    refFeatured = new Firebase("https://finalsrecipe.firebaseio.com/featured"),
    refMenu = new Firebase("https://finalsrecipe.firebaseio.com/menu");
  return {
    ref: function() {
      return ref;
    },
